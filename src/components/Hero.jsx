...
export default function Hero() {
  return (
    <section id="hero" className="relative min-h-screen flex items-center pt-24 pb-12 sm:pt-28 sm:pb-16 lg:py-16 xl:py-24 overflow-hidden bg-white selection:bg-indigo-500/30">
      {/* Background Blobs */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-6 xl:gap-16 items-center">
          ...
          {/* Left Column: Content */}
          <div className="lg:col-span-7 xl:col-span-6 text-left flex flex-col justify-center order-2 lg:order-1 mt-6 lg:mt-0">
            ...
            <h1 className="font-sans font-black text-3xl xs:text-4xl sm:text-5xl lg:text-4xl xl:text-5xl min-[1440px]:text-6xl leading-[1.15] sm:leading-[1.1] tracking-tight text-zinc-900 mb-5 sm:mb-6">
              Scale Your Business With <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4f39f6] via-[#38bdf8] to-[#9333ea]">Custom Software</span> & Systems Automation
            </h1>
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-lg xl:text-xl text-zinc-600 font-normal leading-relaxed max-w-xl mb-6 sm:mb-8">
              I build high-performance <strong className="font-semibold text-zinc-900">web applications, custom CRM platforms, and workflow automations</strong> engineered to eliminate manual bottlenecks and accelerate operational growth.
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mt-10 sm:mt-16 pt-6 sm:pt-8 border-t border-zinc-100">
              {/* Injected Style Block for Continuous 3D Loop Animation */}
              <style dangerouslySetInnerHTML={{__html: `
                ...
                /* Responsive Badge Scaling rules to prevent mobile clipping */
              ...
              <div className="flip-container">
                <div className="flip-card-inner">
                  ...
                  <div className="flip-card-back bg-gradient-to-br from-[#4f39f6] to-[#3724db] text-white shadow-[0_10px_20px_-5px_rgba(79,57,246,0.3)]">
                    <div>
                      <p className="font-sans font-black text-sm sm:text-base leading-tight">100% Done</p>
                      <p className="text-[9px] sm:text-[10px] font-medium text-indigo-100 mt-0.5 leading-tight">On-Time Delivery</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flip-container">
                <div className="flip-card-inner" style={{ animationDelay: '0.8s' }}>
                  <div className="flip-card-front bg-gradient-to-br from-emerald-50/90 via-white to-emerald-50/40 border border-emerald-100 shadow-[0_10px_20px_-5px_rgba(16,185,129,0.1)]">
                    <p className="font-sans font-black text-2xl sm:text-3xl text-emerald-600 tracking-tight">21+</p>
                    <p className="text-[10px] sm:text-xs font-bold text-zinc-500 mt-0.5 leading-tight">Happy Clients</p>
                  </div>
                  <div className="flip-card-back bg-gradient-to-br from-emerald-600 to-emerald-800 text-white shadow-[0_10px_20px_-5px_rgba(16,185,129,0.3)]">
                    <div>
                      <p className="font-sans font-black text-sm sm:text-base leading-tight">Global Trust</p>
                      <p className="text-[9px] sm:text-[10px] font-medium text-emerald-100 mt-0.5 leading-tight">Worldwide Retention</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flip-container">
                <div className="flip-card-inner" style={{ animationDelay: '1.6s' }}>
                  <div className="flip-card-front bg-gradient-to-br from-purple-50/90 via-white to-purple-50/40 border border-purple-100 shadow-[0_10px_20px_-5px_rgba(147,51,234,0.1)]">
                    <p className="font-sans font-black text-2xl sm:text-3xl text-purple-600 tracking-tight">7+</p>
                    <p className="text-[10px] sm:text-xs font-bold text-zinc-500 mt-0.5 leading-tight">Years Experience</p>
                  </div>
                  <div className="flip-card-back bg-gradient-to-br from-purple-600 to-purple-800 text-white shadow-[0_10px_20px_-5px_rgba(147,51,234,0.3)]">
                    <div>
                      <p className="font-sans font-black text-sm sm:text-base leading-tight">Full Stack</p>
                      <p className="text-[9px] sm:text-[10px] font-medium text-purple-100 mt-0.5 leading-tight">Expert Engineering</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flip-container">
                <div className="flip-card-inner" style={{ animationDelay: '2.4s' }}>
                  <div className="flip-card-front bg-gradient-to-br from-amber-50/90 via-white to-amber-50/40 border border-amber-100 shadow-[0_10px_20px_-5px_rgba(245,158,11,0.1)]">
                    <p className="font-sans font-black text-2xl sm:text-3xl text-amber-600 tracking-tight flex items-center gap-1">
                      4.9
                      <Star className="w-4 h-4 sm:w-5 sm:h-5 fill-amber-500 text-amber-500 inline" />
                    </p>
                    <p className="text-[10px] sm:text-xs font-bold text-zinc-500 mt-0.5 leading-tight">Google Review</p>
                  </div>
                  <div className="flip-card-back bg-gradient-to-br from-amber-500 to-amber-600 text-white shadow-[0_10px_20px_-5px_rgba(245,158,11,0.3)]">
                    <div>
                      <p className="font-sans font-black text-sm sm:text-base leading-tight flex items-center justify-center gap-0.5">
                        4.9/5.0 <Star className="w-3 h-3 fill-white text-white inline" />
                      </p>
                      <p className="text-[9px] sm:text-[10px] font-medium text-amber-50 mt-0.5 leading-tight">Top Rated Quality</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="lg:col-span-5 xl:col-span-6 flex justify-center items-center order-1 lg:order-2 relative select-none px-4 sm:px-0">
            {/* Dots Decorations */}
            ...
            {/* Avatar Frame Box */}
            <div className="relative w-full max-w-[260px] xs:max-w-[280px] aspect-square sm:max-w-[360px] md:max-w-[400px] lg:max-w-full lg:w-[420px] lg:h-[420px] flex items-center justify-center mb-4 sm:mb-6 lg:mb-0">
              ...
              <div className="avatar-badge absolute top-0 -left-4 sm:-left-6 bg-white border border-zinc-100/80 p-2 sm:p-3 rounded-xl sm:rounded-2xl shadow-[0_15px_30px_rgba(79,57,246,0.12)] scale-90 sm:scale-100 transition-all duration-300 flex items-center gap-1.5 sm:gap-2.5 animate-[bounce_3s_infinite_ease-in-out]">
              ...
              <div className="avatar-badge absolute -bottom-2 sm:-bottom-4 bg-white border border-zinc-100/85 p-2 sm:p-3 rounded-xl sm:rounded-2xl shadow-[0_20px_40px_rgba(147,51,234,0.15)] scale-90 sm:scale-100 transition-all duration-300 flex items-center gap-2 sm:gap-3 min-w-[130px] sm:min-w-[190px] animate-[bounce_3s_infinite_ease-in-out_0.5s]">
                ...
                <div>
                  <p className="text-[10px] sm:text-xs font-black text-zinc-900 leading-tight">Full Stack Developer</p>
                  <p className="text-[8px] sm:text-[10px] font-medium text-zinc-400 mt-0.5">7 Years+ Experience</p>
                </div>
              </div>
            </div>
